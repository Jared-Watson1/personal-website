...
export default function Footer() {
  return (
    <footer className="relative w-full py-6 text-[#474853] shadow-inner">
      <div className="mx-auto flex flex-col md:flex-row justify-between items-center max-w-screen-xl px-6">
        {/* Footer Title */}
        <span className="text-sm font-semibold text-[#474853]">
        ...
        <div className="flex space-x-6 mt-4 md:mt-0">
          ...
          <a
            ...
            className="text-[#474853] hover:text-[#00A5E3] transition-transform transform hover:scale-110 flex items-center"
          >
            <svg
              className="w-6 h-6"
              aria-hidden="true"
